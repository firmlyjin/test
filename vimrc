...
set cmdheight=2                                       "设置命令行的高度为2，默认为2
...
"                          << bash-supprt.vim>>
" =============================================================================
" 定义leader引导键，就能使用诸如",sf" ",sfu"等命令了。
let BASH_MapLeader = ','


" " =============================================================================
"                          << TxtBrowser.vim>> 看txt文档的插件
" =============================================================================
syntax on
...
"                          << Evervim.vim>>
" =============================================================================
"let g:evervim_devtoken="S=s87:U=8e46d9:E=155ec5e3410:C=14e94ad05a0:P=1cd:A=en-devtoken:V=2:H=3bba729c35f52805ef8b0ddf6134f1ff"
" Key_and_command_bind: 按键及命令绑定{{{1
"if !hasmapto('<leader>enl','n')
"    nmap <silent> <leader>enl :EvervimNotebookList<CR>
"endif
"
" =============================================================================
"                          << 复制、粘贴>>
